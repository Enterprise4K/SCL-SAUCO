...
class viewsModels
{
    ...
    {
        $listaBlanca = ["home", "oc-year", "oc-mes", "oc-semana", "oc-detalle", "oc-list", "usuarios", "usuario-actualizar", "usuario-busqueda", "proveedor", "proveedor-actualizar", "proveedor-busqueda", "empresa"];
