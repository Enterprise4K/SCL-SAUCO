                ...
                <div class="card">
                    <div class="card-body">
                        <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
                            <!-- input para enviar el tipo de modulo se envía los datos de búsqueda de proveedor -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        echo $inst_usuario->paginador_usuario_controlador($pagina[1], 15, $_SESSION['privilegio_scl'], $_SESSION['id_scl'], $pagina[0], $_SESSION['busqueda_usuario']);
                        ?>
                    </div>
                </div>
            </div>
