                    ...
                    <form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/ordenCompraAjax.php" method="POST" data-form="save" autocomplete="off">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="Compra_Serie_reg" maxlength="4" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Correlativo</label>
                                <input type="text" class="form-control" name="Compra_Correlativo_reg" maxlength="10" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Fecha de Emisión</label>
                                <input type="date" class="form-control" name="Compra_FechaEmision_reg" required>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label class="form-label">Fecha de Vencimiento</label>
                                <input type="date" class="form-control" name="Compra_FechaVencimiento_reg" required>
                            </div>
                            <div class="mb-3">
